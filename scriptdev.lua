...
-- ============================================================
-- AUTH CHECK - WAJIB LEWAT LOADER
-- ============================================================

if _G.SPIKE_LOADER_AUTH ~= "hzgg-beep-2026-secret"
    or _G.SPIKE_LOADER_VERIFIED ~= true then

    gg.setVisible(false)
    gg.alert(
        " AKSES DITOLAK!\n\n" ..
        "Script ini cuma bisa dijalankan lewat Loader resmi.\n\n" ..
        "Buka: Loader.lua"
    )
    os.exit()
end
...
-- ============================================================
-- AUTO WIN (MY+ EN+) - RESET + PATCH + OFFSET
-- ============================================================

function autoWinMyEn()
    gg.setRanges(gg.REGION_CODE_APP)
    
    gg.clearResults()

    -- ============================================================
    -- STEP 1: Scan pattern panjang
    -- ============================================================
    local pattern = "hE0 03 15 AA 8F 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA CF 23 0D 94 15 69 00 F0 B5 22 3A 91 21 DF FC D0 21 C4 06 91 E0 03 15 AA 85 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA C5 23 0D 94 15 69 00 F0 B5 62 3A 91 21 DF FC D0 21 40 07 91 E0 03 15 AA 7B 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA BB 23 0D 94 15 69 00 F0 B5 A2 3A 91 21 DF FC D0 21 E0 07 91 E0 03 15 AA 71 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA B1 23 0D 94 15 69 00 F0 B5 E2 3A 91 21 DF FC D0 21 68 08 91 E0 03 15 AA 67 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA A7 23 0D 94 15 69 00 F0 B5 22 3B 91 21 DF FC D0 21 FC 08 91 E0 03 15 AA 5D 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 9D 23 0D 94 15 69 00 F0 B5 62 3B 91 21 DF FC D0 21 A4 09 91 E0 03 15 AA 53 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 93 23 0D 94 15 69 00 F0 B5 A2 3B 91 21 DF FC D0 21 34 0A 91 E0 03 15 AA 49 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 89 23 0D 94 15 69 00 F0 B5 E2 3B 91 21 DF FC D0 21 D8 0A 91 E0 03 15 AA 3F 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 7F 23 0D 94 15 69 00 F0 B5 22 3C 91 21 DF FC D0 21 2C 0B 91 E0 03 15 AA 35 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 75 23 0D 94 15 69 00 F0 B5 62 3C 91 21 DF FC D0 21 40 0C 91 E0 03 15 AA 2B 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA 6B 23 0D 94 15 69 00 F0 B5 A2 3C 91 21 DF FC D0 21 8C 0C 91 E0 03 15 AA 21 24 0D 94 E0 03 14 AA E1 03 15 AA E2 03 13 AA F4 4F 42 A9 F5 0B 40 F9 FD 7B C3 A8 5E 23 0D 14 FF 03 05 D1 E9 23 0D 6D FD 7B 0E A9 FC 6F 0F A9 FA 67 10 A9 F8 5F 11 A9 F6 57 12 A9 F4 4F 13 A9 FD 83 03 91 48 D0 3B D5 8A 20 00 D0 15 E0 BF 12 E8 03 00 F9 F4 03 00 AA F3 03 01 AA 08 15 40 F9 A8 03 1E F8 E8 23 01 91 FF 5B 00 B9 4A 39 45 F9 F5 7F 00 B9 FF 3B 00 F9 49 01 40 F9 48 01 00 F9 48 A8 FC 90 08 9D 1F 91 E8 2B 00 F9 88 20 00 D0 08 89 45 F9 E9 27 00 F9 F5 8F 00 B9 00 01 40 F9 FF 43 00 F9 28 23 00 D0 F5 9F 00 B9 08 B1 43 F9 09 00 40 F9 FF 4B 00 F9 F5 6F 00 B9 01 09 40 B9 28 09 40 F9 FF 33 00 F9 00 01 3F D6 28 00 80 52 F5 37 00 B9 FF 17 00 F9 F5 27 00 B9 FF 0F 00 F9 F5 17 00 B9 FF 07 00 F9 E8 5B 00 B9 36 23 0D 94 A0 17 00 36"
    ...
    if #hasil == 0 then
        gg.alert(" [AutoWin] Pattern tidak ditemukan!")
        gg.clearResults()
        return false
    end
    -- ============================================================
    -- STEP 2: Refine ke -108 (byte)
    -- ============================================================
    gg.refineNumber("-108", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)

    local hasilRefine = gg.getResults(100000)

    if #hasilRefine == 0 then
        gg.alert(" Refine Not Found")
        gg.clearResults()
        return false
    end
    -- ============================================================
    -- STEP 3: Ubah semua jadi 0
    -- ============================================================
    local listNol = {}
    for _, v in ipairs(hasilRefine) do
        if v.address and v.address ~= 0 then
            listNol[#listNol + 1] = {
                address = v.address,
                flags = gg.TYPE_BYTE,
    ...
    local ok1 = pcall(function() gg.setValues(listNol) end)
    if not ok1 then
        gg.alert(" Refine Not Found!")
        gg.clearResults()
        return false
    ...
    -- ============================================================
    -- STEP 4: Ubah lagi jadi -108
    -- ============================================================
    local listMinus108 = {}
    for _, v in ipairs(hasilRefine) do
        if v.address and v.address ~= 0 then
            listMinus108[#listMinus108 + 1] = {
                address = v.address,
                flags = gg.TYPE_BYTE,
                value = -108
            }
    ...
    local ok2 = pcall(function() gg.setValues(listMinus108) end)
    if not ok2 then
        gg.alert(" Refine Not Found!")
        gg.clearResults()
        return false
    ...
    -- ============================================================
    -- STEP 5: Offset +4, cari 54 (byte)
    -- ============================================================
    -- Ambil alamat dari hasil refine, offset +4
    local offsetList = {}
    for _, v in ipairs(hasilRefine) do
        if v.address and v.address ~= 0 then
            offsetList[#offsetList + 1] = {
    ...
    -- Cari nilai 54 (byte)
    gg.refineNumber("54", gg.TYPE_BYTE, false, gg.SIGN_EQUAL, 0, -1, 0)

    local hasil54 = gg.getResults(100000)
    ...
    -- ============================================================
    -- STEP 6: Ubah 54 jadi 0
    -- ============================================================
    local list54Nol = {}
    for _, v in ipairs(hasil54) do
        if v.address and v.address ~= 0 then
            list54Nol[#list54Nol + 1] = {
                address = v.address,
                flags = gg.TYPE_BYTE,
                value = 0
            }
    ...
    local ok3 = pcall(function() gg.setValues(list54Nol) end)
    if not ok3 then
        gg.alert(" Refine Not Found!")
        gg.clearResults()
        return false
    ...
    local ok4 = pcall(function() gg.setValues(list53) end)
    if not ok4 then
        gg.alert(" Refine Not Found!")
        gg.clearResults()
        return false
    ...
    gg.alert(" AUTO WIN (MY+ EN+) BERHASIL!")
    return true
end
-- ============================================================
-- AUTO WIN (MY+ EN+)V2 - RESET + PATCH + OFFSET
-- ============================================================

function autoWinMyEn2()
    gg.setRanges(gg.REGION_CODE_APP)
    ...
    if #hasil == 0 then
        gg.alert(" My+ En+,ball GAGAL DI AKTIFKAN SECARA OTOMATIS!")
        gg.clearResults()
        return false
    end
    -- ============================================================
    ...
    gg.alert(" My+ En+,ball BERHASIL DI HIDUPKAN\nJIKA SAAT DI LOBBY BELUM AKTIF COBALAH UNTUK MELAKUKAN RELOG/LOGIN ULANG !")
    return true
end
-- ============================================================
-- MENU UTAMA
